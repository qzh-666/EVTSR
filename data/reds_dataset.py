...
class REDSDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        assert opt[num_frame] % 2 == 1, (fnum_frame should be odd number, but got {opt[num_frame]})
        ...
        if opt[val_partition] == REDS4:
            ...
            raise ValueError(fWrong validation partition {opt[val_partition]}.
                             fSupported ones are [official, REDS4].)
    ...
    def __getitem__(self, index):
        ...
        assert len(neighbor_list) == self.num_frame, (fWrong length of neighbor list: {len(neighbor_list)})
